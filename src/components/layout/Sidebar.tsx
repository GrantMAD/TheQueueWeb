...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 border-r border-white/10 bg-black/95 backdrop-blur-xl transition-transform duration-300 ease-in-out md:static md:translate-x-0 md:bg-transparent",
